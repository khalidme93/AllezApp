...
open class ExercisesItemsAdapter(
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.setOnClickListener {
                if (model.isSelected()) {
                    ...
                    myExercises!!.remove(model)
                } else if (!model.isSelected()) {
                    model.setSelected(true)
                    myExercises!!.add(model)
                }
                ...
                it.setBackgroundColor(if (model.isSelected()) Color.GRAY else Color.WHITE)

                Log.d("exercises", "my final list " + myExercises!!.size);
    ...
    fun getMyExercises(): ArrayList<Exercises>? {
        return myExercises;
    }
